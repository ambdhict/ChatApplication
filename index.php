...
<head>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="_public/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- Theme style -->
...
<div class="login-box">
  <div class="login-logo">
    <a href=""><b>Messaging</b>Web App</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <?php
        if(isset($_SESSION["error"])){
            ...
            echo "<p class='text-center text-danger font-weight-bold'>$error</p>";
        }
        if (logged_in_acct()){ 
            header('location:_profile/dashboard.php');
        }
    ?>
      <form action="_profile/dashboard.php" method="POST">
...
<!-- AdminLTE App -->
<script src="_public/dist/js/adminlte.min.js"></script>
</body>
</html>
